...
public class OCRUtil {
    ...
    public static Map getData_jiro(JSONObject obj) {
        Map<String, String> map = new HashMap<>();
        JSONArray images = (JSONArray) obj.get("images");
        JSONObject jo = (JSONObject) images.get(0);
        JSONArray fields = (JSONArray) jo.get("fields");
        ...
        JSONObject type_obj = (JSONObject) fields.get(0);
        type = (String) type_obj.get("inferText");
        JSONObject comnum_obj = (JSONObject) fields.get(1);
        comnum = (String) comnum_obj.get("inferText");
