    ...
    let map03 = {
        ...
        init: function () {
            ...
            $('#s_btn').click(function () {
                map03.go(37.579384, 126.977028, 's');
            });
            $('#b_btn').click(function () {
                map03.go(35.158637, 129.160442, 'b');
            });
            $('#j_btn').click(function () {
                map03.go(33.361506, 126.529170, 'j');
            });
        },
        display: function () {
            var mapContainer = document.querySelector('#map03 > #map'); // 지도를 표시할 div
            var mapOption = {
                center: new kakao.maps.LatLng(37.544964, 127.056490), // 지도의 중심좌표
                level: 5 // 지도의 확대 레벨
            };
            ...
            // 마커가 표시될 위치입니다
            var markerPosition = new kakao.maps.LatLng(37.544964, 127.056490);
            // 마커를 생성합니다
